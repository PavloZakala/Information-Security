...
if __name__ == "__main__":
    from tools import string2bytes

    assert "36a9e7f1c95b82ffb99743e0c5c4ce95d83c9a430aac59f84ef3cbfab6145068" == sha_256(string2bytes(" ")).hex()
    assert "185f8db32271fe25f561a6fc938b2e264306ec304eda518007d1764826381969" == sha_256(string2bytes("Hello")).hex()
    assert "3128f8ac2988e171a53782b144b98a5c2ee723489c8b220cece002916fbc71e2" == sha_256(
        string2bytes("sha-256")).hex()
